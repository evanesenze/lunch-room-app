  ...
  return fill ? (
    <Svg width={size} height={size} viewBox="0 0 23 22" fill="none">
      ...
      <Path
        ...
        stroke-linejoin="round"
      />
      <Path d="M5 7.80176H11" stroke="#FF4F5A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <Path d="M5.75 11.6885H10.25" stroke="#FF4F5A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </Svg>
  ) : (
    <Svg width={size} height={size} viewBox="0 0 23 22" fill="none">
      <Path
